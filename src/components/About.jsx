export default function About() {
    return (
        <section 
            id="about" 
            className="flex flex-col items-center justify-center min-h-screen bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-center px-6 transition-colors duration-300"
        >
            {/* Section Title */}
            ...
            {/* Description */}
            <p className="mt-6 text-gray-300 dark:text-gray-700 text-lg md:text-xl max-w-3xl leading-loose">
