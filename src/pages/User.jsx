            ...
            <FadeIn>
                <div className="max-w-screen-md">
                    ...
                    <p className="mt-6 text-gray-300 text-sm sm:text-base px-2 sm:px-6">
                        ...
                        <a href='/terminal'><span className="text-blue-400 font-semibold">Terminal</span></a> Section and type <code className="bg-gray-800 text-yellow-300 px-1 rounded">help</code> to get started.
                    </p>
